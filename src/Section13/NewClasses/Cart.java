...
//	}
    ...
    // Discount é uma inner class, pois está declarada dentro da classe Cart, porém, não é uma classe static
    ...
    // Neste caso, Tax é uma nested class, pois não faz sentido Tax existir sem o Cart.
    // Pois quando o Cart está vazio, não tem nenhuma Tax para ser cobrada, então implementamos ela dentro da classe Cart, como uma Nested Class
