...
// Caso eu coloque o "final" aqui no User, ele não poderá ser herdado em nenhuma classe.
public final class User {

    // Concrete Class
    // Uma classe concreta é uma classe onde todos os seus métodos tem uma implementação
